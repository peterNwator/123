...
import com.globatrides.customer.activity.AllNewsActivity;
import com.globatrides.customer.activity.IntroActivity;
import com.globatrides.customer.activity.PromoActivity;
import com.globatrides.customer.activity.TopupSaldoActivity;
import com.globatrides.customer.activity.WalletActivity;
import com.globatrides.customer.activity.WithdrawActivity;
import com.globatrides.customer.constants.BaseApp;
import com.globatrides.customer.item.AllServiceItem;
import com.globatrides.customer.item.NewsItem;
import com.globatrides.customer.item.CatMerchantItem;
import com.globatrides.customer.item.CatMerchantNearItem;
import com.globatrides.customer.item.ServiceItem;
import com.globatrides.customer.item.MerchantItem;
import com.globatrides.customer.item.MerchantNearItem;
import com.globatrides.customer.item.RatingItem;
import com.globatrides.customer.item.SliderItem;
...
import com.globatrides.customer.models.AllServiceModel;
import com.globatrides.customer.models.ServiceDataModel;
import com.globatrides.customer.models.ServiceModel;
import com.globatrides.customer.models.MerchantModel;
import com.globatrides.customer.models.MerchantNearModel;
import com.globatrides.customer.models.PayuModel;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (totalMenitNow >= totalpagi && totalMenitNow <= totalsiang && totalMenitNow <= totalsore && totalMenitNow <= totalmalam ) {
            nighttext.setText(context.getString(R.string.good_morning));
        } else if (totalMenitNow >= totalpagi && totalMenitNow >= totalsiang && totalMenitNow <= totalsore && totalMenitNow <= totalmalam ) {
            nighttext.setText(context.getString(R.string.good_afternoon));
        } else if (totalMenitNow >= totalpagi && totalMenitNow >= totalsiang && totalMenitNow >= totalsore && totalMenitNow <= totalmalam ) {
            nighttext.setText(context.getString(R.string.good_afternoon));
        } else {
            nighttext.setText(context.getString(R.string.good_evening));
        }
        ...
        if(getLocation != null) {
            ...
            new Handler().postDelayed(() -> {
                if (sp.getSetting()[16] != null && sp.getSetting()[17] != null) {
                    ...
                    getLocation = new Location("globatrides");
            ...
            public void onResponse(@NonNull Call<GetHomeResponseJson> call, @NonNull Response<GetHomeResponseJson> response) {
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        sp.updatemapsride(response.body().getMapsride());
                        ...
                        for (int i = 0; i < fiturdata.size(); i++) {
                            ...
                            fiturmodel.setMaps(fiturdata.get(i).getMaps());

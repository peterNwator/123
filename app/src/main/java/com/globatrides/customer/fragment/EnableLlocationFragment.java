...
public class EnableLlocationFragment extends Fragment {
        ...
        switch (requestCode) {
            case 123:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(context, context.getString(R.string.grant_permission), Toast.LENGTH_SHORT).show();
                }
                break;
        }
    ...
    public void GPSStatus() {
        ...
        if(!gps_enabled && !network_enabled) {
            Toast.makeText(context, context.getString(R.string.loc_accuracy), Toast.LENGTH_SHORT).show();

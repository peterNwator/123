...
public class RentCarGmapActivity extends AppCompatActivity
    ...
    Context context = RentCarGmapActivity.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_gmap);
    ...
    private void updateDistance(long jam) {
        ...
        Utility.currencyTXT(diskon, String.valueOf(promocode), RentCarGmapActivity.this);
        checkedpaywallet = "0";
        distance = jam;
                ...
                public void run() {
                    ...
                    for (DriverModel cDriver : driverAvailable) {
                        if (cDriver.getId().equals(response.getId())) {
                            ...
                            Intent intent = new Intent(RentCarGmapActivity.this, ProgressActivity.class);

...
import com.globatrides.customer.activity.SendDetailActivity;
...
public class SendGmapActivity extends AppCompatActivity
    ...
    private okhttp3.Callback updateRouteCallback = new okhttp3.Callback() {
        ...
        public void onResponse(@NonNull okhttp3.Call call, okhttp3.Response response) throws IOException {
            if (response.isSuccessful()) {
                ...
                final long distance = MapDirectionAPI.getDistance(SendGmapActivity.this, json);
                final String time = MapDirectionAPI.getTimeDistance(SendGmapActivity.this, json);
                if (distance >= 0) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_gmap);
    ...
    private void updateLineDestination(String json) {
        Directions directions = new Directions(SendGmapActivity.this);
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(SendGmapActivity.this, R.color.colorgradient))
                        .width(8));
    ...
    private void updateDistance(long distance) {
        ...
        this.distance = ((float) (distance)) / 1000f;
    ...
    private void onNextButtonClick() {
        ...
        intent.putExtra("pickup_latitude", pickUpLatLang.latitude);
        intent.putExtra("pickup_longitude", pickUpLatLang.longitude);
        intent.putExtra("destination_latitude", destinationLatLang.latitude);
        intent.putExtra("destination_longitude", destinationLatLang.longitude);

...
import com.globatrides.customer.models.PromoCodeModel;
        ...
        holder.salin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.HONEYCOMB) {
                    ...
                    android.content.ClipData clip = android.content.ClipData.newPlainText(mContext.getString(R.string.copied), singleItem.getKodepromo());

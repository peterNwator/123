...
import com.globatrides.customer.activity.DetailMerchantActivity;
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        ...
        try{
            ...
            if (totalMenitNow <= totalMenitTutup && totalMenitNow >= totalMenitBuka) {
                holder.distance.setText(format+"km"+" "+mContext.getString(R.string.text_with_bullet)+" "+ mContext.getString(R.string.open));
            } else {
                holder.distance.setText(format+"km"+" "+mContext.getString(R.string.text_with_bullet)+" "+ mContext.getString(R.string.close_store));
            }

package com.globatrides.customer.utils;
...
public class SettingPreference {
    ...
    private static String MAPSRIDE = "MAPSRIDE";
    ...
    public void updatemapsride(String string) {
        editor = pref.edit();
        editor.putString(MAPSRIDE, string);
        editor.commit();
    }
    ...
    public String[] getSetting() {
        ...
        String[] settingan = new String[21];
        ...
        settingan[19] = pref.getString(DECIMAL, "2");
        settingan[20] = pref.getString(MAPSRIDE, "0");

package com.globatrides.customer.utils.api;

import android.content.Context;

import com.google.android.gms.maps.model.LatLng;
import com.globatrides.customer.R;
import com.globatrides.customer.gmap.GMapDirection;
import com.globatrides.customer.gmap.directions.Directions;
import com.globatrides.customer.gmap.directions.Leg;
import com.globatrides.customer.gmap.directions.Route;
import com.globatrides.customer.gmap.directions.Step;
...
public class MapDirectionAPI {
    ...
    public static Call getAddress(LatLng address, Context context) {
        OkHttpClient client = new OkHttpClient();

        Request request = new Request.Builder()
                .url("https://maps.googleapis.com/maps/api/geocode/json?latlng="+address.latitude+","+address.longitude+"&key="+ context.getString(R.string.google_maps_key))
                .build();

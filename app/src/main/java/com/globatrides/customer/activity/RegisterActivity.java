...
import com.globatrides.customer.models.FirebaseToken;
...
public class RegisterActivity extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageByteArray == null) {
                    notif(getString(R.string.photo_toast));
                    ...
                    notif(getString(R.string.name_toast));
                    ...
                    notif(getString(R.string.dob_toast));

                } else if (!emailvalidate.matches(emailPattern)) {

                    notif(getString(R.string.emailformat_toast));
    ...
    public void Nextbtn(View view) {
        ...
        if ((!TextUtils.isEmpty(phoneNumber) && !TextUtils.isEmpty(ccode)) && phoneNumber.length() > 5) {
            ...
            notif(getString(R.string.recheck_phone));
        }
    }
...
//sendcode-----------------------
    ...
    private void setUpVerificatonCallbacks() {
        verificationCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                notif2(getString(R.string.verify_failed));
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    notif2(getString(R.string.wrong_code));
                } else if (e instanceof FirebaseTooManyRequestsException) {
                    notif2(getString(R.string.limit_request_number));
                    notif(getString(R.string.limit_request_phonenumber));
                }
            }
    ...
    public void verifyCode(View view) {
        ...
        if (!code.equals("")) {
            ...
            notif2(getString(R.string.enter_verifycode));
        }
            ...
            public void onResponse(@NonNull Call<RegisterResponseJson> call, @NonNull Response<RegisterResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("next")) {
                        ...
                        saveUser(user);
                        SettingPreference sp = new SettingPreference(RegisterActivity.this);

...
import com.globatrides.customer.item.ItemOrderItem;
...
import com.globatrides.customer.models.LokasiDriverModel;
...
import com.globatrides.customer.utils.NetworkManager;
...
import static com.globatrides.customer.utils.api.service.MessagingService.BROADCAST_ORDER;
...
public class ProgressActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderButton.setOnClickListener(view -> {
            if (isCancelable) {
                ...
                alertDialogBuilder.setTitle(getString(R.string.cancel_order));
                alertDialogBuilder.setMessage(getString(R.string.cancel_order_confirmation));
            ...
            public void onResponse(@NonNull Call<DetailTransResponseJson> call, @NonNull Response<DetailTransResponseJson> responsedata) {
                if (responsedata.isSuccessful()) {
                    ...
                    if (transaksi.isPakaiWallet()) {
                        totaltext.setText(getString(R.string.total_wallet));
                    } else {
                        totaltext.setText(getString(R.string.total_cash));
                    }
                    ...
                    if (!designedFitur.getHome().equals("3")) {
                        ...
                        if (designedFitur.getHome().equals("4")) {
                            ...
                            time.setText(getString(R.string.delivery_fee));
                            costtext.setText(getString(R.string.order_price));
    ...
    private void parsedata(TransModel request, final DriverModel driver, ServiceModel fiturmodel) {
        ...
        if (!response.equals("2")) {
            ...
            if (!response.equals("3")) {
                ...
                if (fiturmodel.getHome().equals("4")) {
                    status.setText(getString(R.string.driver_deliver));
                } else {
            ...
            llchat.setVisibility(View.VISIBLE);
            if (fiturmodel.getHome().equals("4")) {
                status.setText(getString(R.string.driver_buying));
            } else {
        ...
        phone.setOnClickListener(v -> {
            final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ProgressActivity.this, R.style.DialogStyle);
            alertDialogBuilder.setTitle(getString(R.string.call_driver));
            ...
            public void onResponse(@NonNull Call<CancelBookResponseJson> call, @NonNull Response<CancelBookResponseJson> response) {
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).mesage.equals("canceled")) {
                        ...
                        fcmcancel();
                        fcmcancelmerchant();
                        notif(getString(R.string.order_cancel));
                        finish();
                    } else {
                        notif(getString(R.string.failed));
                    }
                }
            }

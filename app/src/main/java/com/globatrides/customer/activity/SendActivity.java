...
public class SendActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void onNextButtonClick() {
        ...
        intent.putExtra("pickup_latitude", pickUpLatLang.getLatitude());
        intent.putExtra("pickup_longitude", pickUpLatLang.getLongitude());
        intent.putExtra("destination_latitude", destinationLatLang.getLatitude());
        intent.putExtra("destination_longitude", destinationLatLang.getLongitude());

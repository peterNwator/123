...
import com.globatrides.customer.models.TransSendModel;
...
import static com.globatrides.customer.activity.SendActivity.FITUR_KEY;
...
public class SendDetailActivity extends AppCompatActivity {
    ...
    double pickup_latitude, pickup_longitude, destination_latitude, destination_longitude;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pickup_latitude = intent.getDoubleExtra("pickup_latitude", 0);
        pickup_longitude = intent.getDoubleExtra("pickup_longitude", 0);
        destination_latitude = intent.getDoubleExtra("destination_latitude", 0);
        destination_longitude = intent.getDoubleExtra("destination_longitude", 0);
        ...
        diskontext.setText(getString(R.string.discount) + fiturModel.getDiskon() + getString(R.string.with_wallet));
        ...
        order.setOnClickListener(view -> {
            if (sendername.getText().toString().isEmpty()) {
                notif(getString(R.string.sendername_toast));
            } else if (senderphone.getText().toString().isEmpty()) {
                notif(getString(R.string.senderphone_toast));
            } else if (recievername.getText().toString().isEmpty()) {
                notif(getString(R.string.receivername_toast));
            } else if (recieverphone.getText().toString().isEmpty()) {
                notif(getString(R.string.receiverphone_toast));
            } else {
                onOrderButton();
            }
        });
    ...
    private void onOrderButton() {
        if (checkedpaywallet.equals("1")) {
            if (driverAvailable.isEmpty()) {
                ...
                param.setStartLatitude(pickup_latitude);
                param.setStartLongitude(pickup_longitude);
                param.setEndLatitude(destination_latitude);
                param.setEndLongitude(destination_longitude);

...
import com.globatrides.customer.gmap.activity.DetailOrderGmapActivity;
import com.globatrides.customer.item.CatItemItem;
...
import com.globatrides.customer.models.CatItemModel;
...
public class DetailMerchantActivity extends AppCompatActivity implements ItemItem.OnCalculatePrice {
    ...
    String id, resume, tutupki, lat, lon, idresto, alamatresto;
        ...
        if (quantity > 0) {
            ...
            pricecountainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (tutupki.equals("0")) {
                        Intent i;
                        ServiceModel designedFitur = realm.where(ServiceModel.class).equalTo("idFitur", idfitur).findFirst();

                        if(designedFitur.getMaps().equals("1")) {
                            i = new Intent(DetailMerchantActivity.this, DetailOrderGmapActivity.class);
                        } else {
                            i = new Intent(DetailMerchantActivity.this, DetailOrderActivity.class);
                        }
                        ...
                        notif(getString(R.string.close_merchant));
                    }
                }
            });
            ...
            public void onResponse(@NonNull Call<MerchantByIdResponseJson> call, @NonNull final Response<MerchantByIdResponseJson> response) {
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        hours.setText( getString(R.string.open_hours) + Objects.requireNonNull(response.body()).getBukamerchant() + "-" + response.body().getTutupmerchant());
    ...
    public void onBackPressed() {
        ...
        if (quantity > 0) {
            new AlertDialog.Builder(this, R.style.DialogStyle)
                    .setTitle(getString(R.string.deleteorder_toast))
                    .setMessage(getString(R.string.deleteorder_confimation))

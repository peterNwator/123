...
public class TopupSaldoActivity extends AppCompatActivity {
        ...
        banktransfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!nominal.getText().toString().isEmpty()) {
                    ...
                    notif(getString(R.string.nominal_toast));
                }
            }
        });
    ...
    private void getPaypal() {
        ...
        if (sp.getSetting()[19].equals("2")) {
            Amount = Double.parseDouble(convertAngka(nominal.getText().toString().replace(sp.getSetting()[0], "")));
        } else {
            Amount = Double.parseDouble(convertAngka(nominal.getText().toString().replace(sp.getSetting()[0], ""))+"00");
        }

                    ...
                    favourite.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (databaseHelper.getFavouriteById(String.valueOf(berita.getIdberita()))) {
                                ...
                                Toast.makeText(NewsDetailActivity.this, getString(R.string.remove_fav), Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                Toast.makeText(NewsDetailActivity.this, getString(R.string.add_fav), Toast.LENGTH_SHORT).show();
                            }

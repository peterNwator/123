...
import com.globatrides.customer.utils.NetworkUtils;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cardnumber.getText().toString().isEmpty()) {
                    notif(getString(R.string.cardnumber_toast));
                } else if (holdername.getText().toString().isEmpty()) {
                    notif(getString(R.string.holdername_toast));
                } else if (expiratedate.getText().toString().isEmpty()) {
                    notif(getString(R.string.expdate_toast));
                } else if (cvc.getText().toString().isEmpty()) {
                    notif(getString(R.string.cvc_toast));
                } else {
            ...
            public void onResponse(@NonNull Call<TopupResponseJson> call, @NonNull Response<TopupResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    if (Objects.requireNonNull(response.body()).getMessage().equalsIgnoreCase("success")) {
                        ...
                        notif(getString(R.string.error_message));
                    }
                } else {
